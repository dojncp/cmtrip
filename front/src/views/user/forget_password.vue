<template>
  <div class="not-found-container">
    <div class="not-found-card">
      ...
      <p class="title">Feature Not Available</p>
      <p class="subtitle">This feature is currently under development</p>
      <p class="subtitle">Please check back later</p>
      <p class="title">功能尚不可用</p>
      <p class="subtitle-chinese">目前尚未开发此功能</p>
      <p class="subtitle-chinese">请见谅</p>
...
onMounted(() => {
  ...
  // Record forget password access 记录忘记密码访问
  console.warn(`Forget password page accessed: ${router.currentRoute.value.fullPath}`)
})
</script>
